  ...
  try {
    ...
    if (this.Class.type === 'ORM') {
      if (this.entity.options.includeNames) {
        json = utils.model.helpers.normalizeFields.aliasFieldsForOutput.apply(this, [underscore.omit(underscore.clone(this.entity.values), this.entity.options.includeNames)]);
        ...
        utils.model.helpers.normalizeAssociations.aliasAssociationsForOutput.apply(this, [json]);
      } else {
        json = utils.model.helpers.normalizeFields.aliasFieldsForOutput.apply(this, [underscore.clone(this.entity.values)]);
      }
    } else {
