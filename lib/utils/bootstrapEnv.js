...
function injectBaseCoreResources() {
  ...
  injector.instance('utils',      require('utils'));
}
...
function bootApplication() {
  ...
  env.moduleLoader = moduleLdr = require(path.resolve(path.join(__dirname, '..', 'classes', 'ModuleLoader.es6'))).getInstance(env);
