...
var modelUtils  = {
    ...
    aliasAssociationForQuery: function(data, fieldName, callback) {
        var hasAssociation  = (this.entity.associations || this.Class.entity.associations)[fieldName]
    ...
    aliasFieldsForQuery: function(fields, callback) {
        if (Object.keys(fields).length > 0) {
            ...
            Object.keys(fields).forEach(function(key) {
                var val            = fields[key]
                  , hasAssociation = (this.entity.associations || this.Class.entity.associations)[key]
                  , newKey;
