...
/** @Prototype */
{
    ...
    // Create a new model
    create: function( data, queryOptions ) {
        var service = this;
    ...
    find: function( idOrFindOptions, queryOptions ) {
        ...
        return new Promise( function( resolve, reject ) {
            ...
            if ( typeof idOrFindOptions === 'object' && service.model.type === 'ORM' ) {
    ...
    findOrCreate: function( idOrFindOptions, data, queryOptions ) {
        var service = this;
        ...
        return new Promise( function( resolve, reject ) {
            ...
            if ( typeof idOrFindOptions === 'object' && typeof idOrFindOptions.where === 'object' && service.model.type === 'ORM' ) {
                Object.keys( idOrFindOptions.where ).forEach( function( name ) {
                    if ( idOrFindOptions.where[ name ] === 'null' ) { 
                        idOrFindOptions.where[ name ] = null;
                    }
            ...
            service.model
                .findOrCreate( idOrFindOptions, data, queryOptions )
                .then( resolve )
                .catch( reject );
        });
    },
    ...
    update: function( idOrFindOptions, data, queryOptions ) {
        var service = this;
        ...
        return new Promise( function( resolve, reject ) {
            ...
            if ( !idOrFindOptions || idOrFindOptions === null ) {
    ...
    destroy: function( idOrFindOptions, queryOptions ) {
        var service = this;
        ...
        return new Promise( function( resolve, reject ) {
            ...
            if ( !idOrFindOptions || idOrFindOptions === null ) {
                reject( new exceptions.ModelNotFound( 'Unable to delete ' + service.model.modelName + ', unable to determine identity.' ) );
            }
