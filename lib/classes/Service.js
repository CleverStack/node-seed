...
/** @Prototype */
{
            ...
            service.model
                ...
                .then( function( model ) {
                    if ( model !== null && !!model && !!model.id ) {
                        ...
                        resolve( { statusCode: 404, message: service.model._name + " doesn't exist." }  );
                    }
                })
                .catch( reject );
    ...
    findAll: function( where ) {
        ...
        return new Promise( function( resolve, reject ) {
            ...
            if ( typeof where === 'object' && service.model.type === 'ORM' ) {
                Object.keys( where.where ).forEach( function( name ) {
