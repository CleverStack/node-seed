...
/* @Class*/
{
   ...
   * @see http://cleverstack.io/documentation/backend/models/#field-types for more information
   */
   ...
   * @see http://cleverstack.io/documentation/backend/models/#events for more information
   */
   ...
   * @see http://cleverstack.io/documentation/backend/models/#creating-instances for more information
   */
   ...
   * @see http://cleverstack.io/documentation/backend/models/#finders-findAll for more information
   */
   ...
   * @see http://cleverstack.io/documentation/backend/models/#updating-or-saving-instances for more information
   */
    ...
    return new Promise(function update(resolve, reject) {
      if (this.debug.enabled) {
        this.debug(util.format(
          'update(%s) %s',
          modelUtils.debugInspect(values), modelUtils.debugInspect(queryOptions)
        ));
      }
   ...
   * @see http://cleverstack.io/documentation/backend/models/#destroying-instances for more information
   */
...
/* @Instance */
{
  ...
  /**
   * Update a model using the provided values (optional, defaults to this.changed())
   * @see http://cleverstack.io/documentation/backend/models/#updating-or-saving-instances for more information
   * 
