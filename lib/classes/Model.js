...
{   
    ...
    extend: function() {
        if ( models[ arguments[ 0 ] ] !== undefined ) {
            debuggr( arguments[ 0 ] + 'Model: Returning model class from the cache...' );
        ...
        // Make sure no one can override our extend function
        if ( Static.extend ) {
    ...
    find: function( id ) {
        var modelType = this.type.toUpperCase
                ? this.type.toUpperCase()
                : this.type
          , isModel = !!this._model && this._model !== null
          , that = this
          , options = !/^[0-9a-fA-F]{24}$/.test( id ) && isNaN( id )
                ? id
                : {};
        ...
        return new Promise(function( resolve, reject ) {
            async.waterfall(
                ...
                function returnFoundModels( err, _models ) {
                    var models = []
                      , _models = _models instanceof Array
                            ? _models
                            : [ _models ];
